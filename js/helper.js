...
var HTMLheaderRole = '<span id="title">%data%</span><hr/>';
...
var HTMLworkEmployer = '<a id="work-item" href="#">%data%';
var HTMLworkTitle = ' - %data%</a>';
var HTMLworkDates = '<br><div class="date-text">%data%</div>';
...
var HTMLschoolMinor = '<em><br>Minor: %data%<br></em>';

var HTMLonlineClasses = '<h3 id="online-class">Online Classes</h3>';
var HTMLonlineTitle = '<a href="#">%data%';
var HTMLonlineSchool = ' - %data%</a>';
var HTMLonlineDates = '<div class="date-text">%data%</div>';
var HTMLonlineURL = '<br><div>%data%</div>';
  ...
  */
  function locationFinder() {
    ...
    for (var school in education.schools) {
      locations.push(education.schools[school].schoolCity);
    }

    // iterates through work locations and appends each location to
    // the locations array (CHANGED .LOCATION)
